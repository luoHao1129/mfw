...
inCity.cssParents = function () { //城市显示
    ...
    $(inCity.id).css({"left": "0px", "width": inCity.width + "px", "height": inCity.height + "px"});
}
...
inCity.allCity = ['北京|beijing|bj', '上海|shanghai|sh', '重庆|chongqing|cq', '深圳|shenzhen|sz', '广州|guangzhou|gz', '杭州|hangzhou|hz',
    '南京|nanjing|nj', '苏州|shuzhou|sz', '达州|dazhou|dz', '成都|chengdu|cd', '南昌|nanchang|nc', '三亚|sanya|sy', '青岛|qingdao|qd',
    ...
    '朝阳|chaoyang|cy', '常德|changde|cd', '长白山|changbaishan|cbs', '赤峰|chifeng|cf', '大同|datong|dt', '大连|dalian|dl', '达州|dazhou|dx', '东营|dongying|dy', '大庆|daqing|dq', '丹东|dandong|dd',
