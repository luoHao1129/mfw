...
layui.use(["okUtils", "countUp"], function () {
    ...
    var userSourceTodayChartOption = {
        ...
        legend: {orient: 'vertical', left: 'left', data: ['北大', '七天', '如家', '视频广告', '搜索引擎']},
        series: [
            {
                name: '订单数量', type: 'pie', radius: '55%', center: ['50%', '60%'],
                data: [{value: 335, name: '北大'}, {value: 310, name: '七天'}, {value: 234, name: '如家'}, {value: 135, name: '视频广告'}, {value: 1548, name: '搜索引擎'}],
    ...
    var userSourceWeekChartOption = {
        ...
        legend: {data: ['机票订单', '酒店订单', '总订单']},
        toolbox: {show: false, feature: {saveAsImage: {}}},
        grid: {left: '3%', right: '4%', bottom: '3%', containLabel: true},
        xAxis: [{type: 'category', boundaryGap: false, data: ['周一', '周二', '周三', '周四', '周五', '周六', '周日']}],
        yAxis: [{type: 'value', splitLine: {show: false},}],
        series: [
            {name: '机票订单', type: 'line', stack: '总量', smooth: true, areaStyle: {}, data: [120, 132, 101, 134, 90, 230, 210]},
            {name: '酒店订单', type: 'line', stack: '总量', smooth: true, areaStyle: {}, data: [220, 182, 191, 234, 290, 330, 310]},
            {name: '总订单', type: 'line', stack: '总量', smooth: true, label: {normal: {show: true, position: 'top'}}, areaStyle: {normal: {}}, data: [370, 932, 901, 934, 1290, 1330, 1320]}
        ]
    };
