...
<body>
	<div style="width: 600px; text-align: left; margin: 0 auto;">
		...
		<div style="border: 1px solid #005da7; font-size: 16px; line-height: 50px; padding: 20px;">
			<div>您好！</div>
			<div>
				亲爱的会员${name }，这是您在仿马蜂窝旅游网站的预定单！</br>
				${hotelName }已预定成功，订单号：${orderId }，请尽快支付！
			</div>
			
			<div style="border-bottom: 2px solid #005da7; height: 2px; width: 100%;"></div>
			<div>扫一扫，关注智谷仿马蜂窝旅游网站微信公共号，里面更多精彩推荐</div>
			<div>
				预览订单详情，请访问 <a href="http://http://localhost:8083/getOrderDetails">订单详情</a>
			</div>
		</div>
	</div>
</body>
